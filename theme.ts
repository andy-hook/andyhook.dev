...
export const curves = {
  ...
  spring:
    'linear(0, 0.038, 0.142, 0.283, 0.44, 0.603, 0.753, 0.881, 0.978, 1.048, 1.094, 1.117, 1.121, 1.112, 1.096, 1.074, 1.05, 1.027, 1.008, 0.993, 0.982, 0.976, 0.973, 0.972, 0.973, 0.976, 0.98, 0.986, 0.991, 0.995, 0.998, 1.000, 1.001, 1.002, 1.0027, 1)',
};
