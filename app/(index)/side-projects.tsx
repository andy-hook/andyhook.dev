  ...
  (props, forwardedRef) => {
    return (
      <section {...props} ref={forwardedRef}>
        <Gutter>
          <Container>
            <div className="mb-12 md:mb-14 lg:mb-20 xxl:mb-24 lg:text-center relative z-10 md:pl-7 lg:pl-0 pt-12 md:pt-20 lg:pt-24 xl:pt-32">
              <h2 className="text-slate-8 font-display font-normal tracking-tighter text-3xl lg:text-4xl xl:text-[40px] xxl:text-5xl capsize leading-tight lg:leading-tight xl:leading-tight xxl:leading-tight max-w-[25em] lg:mx-auto">
                <div className="text-balance text-transparent bg-gradient-to-br from-slate-11 via-slate-9 to-slate-8 bg-clip-text">
                  <span className="text-slate-12">Side projects</span> are where I engage in
                  exploratory areas, guided by <span className="text-slate-12">curiosity</span>,{' '}
