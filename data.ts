...
export const experience: Experience[] = [
  ...
  },
  {
    ...
    description:
      'I was a core maintainer of Radix UI, a popular headless UI library touching millions of end-users. I worked closely with the team to scope, shape, research and implement WAI-ARIA compliant accessible UI patterns and DX-centric component APIs.',
...
export const artifacts: Artifact[] = [
  { name: 'Snow day', year: '2022', src: sketchbookCoupleImage, slug: 'sketchbook-couple' },
  { name: 'Midnight', year: '2016', src: sketchbookScarfImage, slug: 'sketchbook-scarf' },
  { name: 'Male study', year: '2018', src: sketchbookMaleStudyImage, slug: 'sketchbook-male-study' },
  { name: 'Suit', year: '2012', src: sketchbookSuitImage, slug: 'sketchbook-suit' },
  { name: 'Faces', year: '2010', src: sketchbookFacesImage, slug: 'sketchbook-faces' },
  { name: 'Angles', year: '2013', src: sketchbookAnglesImage, slug: 'sketchbook-angles' },
  { name: 'Ashtree', year: '2013', src: sketchbookTreeMarkImage, slug: 'sketchbook-tree-mark' },
  { name: 'Rasputin', year: '2006', src: sketchbookRasputinImage, slug: 'sketchbook-rasputin' },
  {
    name: 'Female study',
    year: '2018',
    src: sketchbookFemaleStudyImage,
    slug: 'sketchbook-female-study',
  },
  { name: 'Energy', year: '2015', src: sketchbookTattooImage, slug: 'sketchbook-tattoo' },
  { name: 'Headspace', year: '2016', src: sketchbookHeadspaceImage, slug: 'sketchbook-headspace' },
  { name: 'Here be dragons', year: '2010', src: sketchbookMapImage, slug: 'sketchbook-map' },
  { name: 'Snowman', year: '2012', src: sketchbookSnowmanImage, slug: 'sketchbook-snowman' },
  {
    name: 'Sands of time',
    year: '2005',
    src: sketchbookSandsTimeImage,
    slug: 'sketchbook-sands-time',
  },
  {
    name: 'Steampunk',
    year: '2007',
    src: sketchbookSteampunkChurchImage,
    slug: 'sketchbook-steampunk-church',
  },
  { name: 'Orc', year: '2004', src: sketchbookOrcImage, slug: 'sketchbook-orc' },
  {
    name: 'Naval carvings',
    year: '2006',
    src: sketchbookNavalCarvingImage,
    slug: 'sketchbook-naval-carving',
  },
  {
    name: 'Short figure studies',
    year: '2005',
    src: sketchbookQuickFigureStudiesImage,
    slug: 'sketchbook-quick-figure-studies',
  },
  { name: 'Still life', year: '2004', src: sketchbookStillLifeImage, slug: 'sketchbook-still-life' },
  { name: 'Contrast', year: '2005', src: sketchbookContrastImage, slug: 'sketchbook-contrast' },
  {
    name: 'Hard surface',
    year: '2007',
    src: sketchbookHardSurfaceImage,
    slug: 'sketchbook-hard-surface',
  },
  { name: 'Julius', year: '2007', src: sketchbookJuliusImage, slug: 'sketchbook-julius' },
  {
